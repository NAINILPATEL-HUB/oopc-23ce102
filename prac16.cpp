...
public:
    ...
    void getcardetails(string model, string fuel, float price, float mileage, string transmission, int tank_capa, int seating_cap, string airbag)
    {
        this->model = model;
        this->fuel = fuel;
        this->price = price;
...
int main()
{
    ...
    while (inf)
    {
        ...
        c[count++].getcardetails(model_name, fuel_type, price1, mileage1, transmission, tank_capacity1, seating1, airbag);
    }
